...
with Adare_Net_Config;
with adare_net.sockets.inners;

use adare_net.sockets.inners;

package body adare_net.sockets.epolls with
 Preelaborate
is
  ...
  begin
    ...
    begin
      ...
      if Alire_Host_OS /= "windows" then
        ...
        return ((where_poll.event_poll.all (index).events and Unsigned_32 (receive_out_band_event)) > 0);
      end if;
  ...
  end confirm_receive_out_band_event;
  ...
  begin
    ...
    begin
      ...
      if Alire_Host_OS /= "windows" then
        ...
        return ((where_poll.event_poll.all (index).events and Unsigned_32 (graceful_closed_socket_err)) > 0);
      end if;
  ...
  end is_gracefull_shutdown_error;
  ...
  begin
    ...
    begin
      ...
      if Alire_Host_OS /= "windows" then
        ...
        return ((where_poll.event_poll.all (index).events and Unsigned_32 (hang_up_socket_err)) > 0);
      end if;
  ...
  begin
    ...
    begin
      ...
      if Alire_Host_OS /= "windows" then
        ...
        return ((where_poll.event_poll.all (index).events and Unsigned_32 (socket_err)) > 0);
      end if;
