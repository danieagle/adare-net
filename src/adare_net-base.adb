...
is
  ...
  --    tmp_addr.addr_length  :=  socklen_t (tmp_addrinfo.ai_addrlen);
  ...
  begin
    ...
    loop
      ...
      begin
        ...
        --      := tmp_sockaddr_storage_ptr.all.padding (
        --        tmp_sockaddr_storage_ptr.all.padding'First ..
        --        tmp_sockaddr_storage_ptr.all.padding'First + size_t (mi_addrinfo.ai_addrlen - 3));
        --  else
        --    tmp_addr.storage.padding := (others => char'Val (0));
        --  end if;
  ...
  --    ret_value : constant Interfaces.C.int :=  inner_getaddrinfo
  --      (host_or_ip_i =>  h_or_i'Address,
  --       port_i       =>  n_p_or_s'Address,
  --       hints_i      =>  hint'Address,
  --       response_i   =>  tmp_getted_response'Address);
